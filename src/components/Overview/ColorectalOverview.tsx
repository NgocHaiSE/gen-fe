const ColorectalOverview = () => {
    return (
        <div className="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-100">
            <h1 className="text-2xl font-bold text-teal-900 mb-6 border-b border-gray-200 pb-2">UNG THƯ ĐẠI TRỰC TRÀNG</h1>
            ...
            <div className="prose prose-blue max-w-none text-gray-700">
                ...
                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm text-teal-700">2.1. Yếu tố nguy cơ không thể thay đổi:</p>
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">2.2. Yếu tố nguy cơ có thể thay đổi:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm text-teal-700">U đại tràng phải:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">U đại tràng trái và trực tràng:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm text-teal-700">4.1. Nội soi đại tràng:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">4.2. Chẩn đoán hình ảnh:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">4.3. Xét nghiệm:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">4.4. Xét nghiệm gen:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
