const BreastOverview = () => {
    return (
        <div className="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-100">
            <h1 className="text-2xl font-bold text-medical-primary mb-6 border-b border-gray-200 pb-2">UNG THƯ VÚ</h1>
            ...
            <div className="prose prose-blue max-w-none text-gray-700">
                ...
                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm">2.1. Yếu tố không thể thay đổi:</p>
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">2.2. Yếu tố có thể thay đổi:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm">4.1. Chẩn đoán hình ảnh:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">4.2. Sinh thiết:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">4.3. Xét nghiệm gen:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6 mb-3">5. Phân loại</h2>
