const LiverOverview = () => {
    return (
        <div className="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-100">
            <h1 className="text-2xl font-bold text-medical-primary mb-6 border-b border-gray-200 pb-2">UNG THƯ GAN</h1>
            ...
            <div className="prose prose-blue max-w-none text-gray-700">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">2.1. Phòng ngừa UTBMTBG:</p>
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6 mb-3">3. Chẩn đoán ung thư gan</h2>

                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm">3.1. Khám lâm sàng và các xét nghiệm cận lâm sàng:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">3.2. Hình ảnh học:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">3.3. Chỉ dấu sinh học:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
