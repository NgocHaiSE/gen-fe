const ThyroidOverview = () => {
    return (
        <div className="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-100">
            <h1 className="text-2xl font-bold text-medical-primary mb-6 border-b border-gray-200 pb-2">UNG THƯ TUYẾN GIÁP</h1>
            ...
            <div className="prose prose-blue max-w-none text-gray-700">
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6 mb-3">2. Phân loại mô bệnh học</h2>
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6 mb-3">3. Nguyên nhân và yếu tố nguy cơ</h2>

                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm">3.1. Yếu tố nguy cơ:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">3.2. Đột biến gen liên quan:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6 mb-3">4. Triệu chứng lâm sàng</h2>
                <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <h2 className="text-xl font-bold text-gray-800 mt-6 mb-3">5. Chẩn đoán</h2>

                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm">5.1. Chẩn đoán hình ảnh:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">5.2. Chọc hút kim nhỏ (FNA):</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm">5.3. Xét nghiệm máu:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                        <li>TSH, FT4, FT3</li>
