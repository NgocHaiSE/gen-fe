...
const LungOverview = () => {
    return (
        <div className="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-100 animate-fade-in">
            <h1 className="text-2xl font-bold text-teal-900 mb-6 border-b border-gray-200 pb-2">UNG THƯ PHỔI</h1>
            ...
            <div className="prose prose-blue max-w-none text-gray-700">
                ...
                <div className="pl-4 mt-2">
                    <p className="font-bold text-sm text-teal-700">1. Thuốc lá:</p>
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">2. Amiăng:</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <div className="pl-4 mt-4">
                    <p className="font-bold text-sm text-teal-700">3. Ô nhiễm không khí</p>
                    <ul className="list-disc pl-5 space-y-1 text-sm text-justify">
                ...
                <h2 className="text-xl font-bold text-teal-800 mt-6 mb-3">3. Lâm sàng</h2>
                <p className="indent-6 text-justify leading-7 text-sm">
